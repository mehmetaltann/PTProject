...
import { useGetBudgetItemsQuery } from "../../redux/apis/budgetApi";
import {
  Paper,
  MenuItem,
  Select,
...
const BudgetStatisticsMain = () => {
  ...
  }, [isLoading, isFetching, budgetObjectList]);
  ...
  function handleQuery() {
    if (months.length === 0) {
      ...
      const filtData = budgetObjectList
...
export default BudgetStatisticsMain;
